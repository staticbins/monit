...
2.6.33):
 ...
 -----------------------------------------------------------------------------------------------
 | Platform     | user | system | wait | nice | hardirq | softirq | steal | guest | guest nice |
 -----------------------------------------------------------------------------------------------
 | AIX          |  X   |   X    |  X   |      |         |         |       |       |            |
 | DragonFlyBSD |  X   |   X    |      |      |         |         |       |       |            |
 | FreeBSD      |  X   |   X    |      |      |         |         |       |       |            |
...
an absolute value or percent of the system soft/hard limit which is set for the system
(/proc/sys/fs/file-max) or process (ulimit -n).
