...
uses AUTO. In AUTO mode, only TLS 1.2 and 1.3 is allowed, all other
protocols are considered obsolete. If you have to use the obsolete
protocol you must explicitly set the version.
