...
=head2 PROCESS FILEDESCRIPTORS TEST

Monit can test the number of open filedescriptors of a process. You can check either
...
You can also check accumulated number for the process and all its children (absolute
value only).
