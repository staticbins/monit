...
The content statement can be used to test the content of a program by using
regular expressions.
...
Copyright (C) 2001-2023 by Tildeslash Ltd. All Rights Reserved.
